...
interface MineralWatchWinbackProps {
  firstName?: string;
}

export const MineralWatchWinback = ({
  firstName = 'there',
}: MineralWatchWinbackProps) => (
  <Html>
    <Head />
    <Body style={main}>
      <Preview>We've fixed issues and made major improvements to Mineral Watch</Preview>
      <Container style={container}>
        <Section style={box}>
          ...
          <Text style={paragraph}>
            I'm James, the founder of Mineral Watch. I saw that you previously
            canceled your account, and I completely understand that you needed
            something that worked reliably for you.
          </Text>
          <Text style={paragraph}>
            If you had trouble adding properties before, it may have been
            related to a permissions issue that affected a few accounts. We've
            since fixed it and strengthened the permissions system overall.
          </Text>
          <Text style={paragraph}>
          ...
          <Text style={{ ...paragraph, marginTop: '24px' }}>
            You can explore what's new here:
          </Text>
          <Button style={button} href="https://mymineralwatch.com/features">
            See What's New
          </Button>
          <Text style={paragraph}>
            We appreciate you giving Mineral Watch a try in the past, and we'd
            welcome any feedback on what would make it truly valuable for you.
            If you ever decide to revisit it — or if you have questions — I'm
...
export default MineralWatchWinback;
